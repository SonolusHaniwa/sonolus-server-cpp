...
auto web_index = [](client_conn conn, http_request request, param argv) {
    ...
    argList["html.levelsTitle"] = fetchIndexTitle("/levels/search", "/levels/list", "levels").output();
    ...
    argList["html.skinsTitle"] = fetchIndexTitle("/skins/search", "/skins/list", "skins").output();
    ...
    argList["html.backgroundsTitle"] = fetchIndexTitle("/backgrounds/search", "/backgrounds/list", "backgrounds").output();
    ...
    argList["html.effectsTitle"] = fetchIndexTitle("/effects/search", "/effect/list", "effects").output();
    ...
    argList["html.particlesTitle"] = fetchIndexTitle("/particles/search", "/particles/list", "particles").output();
    ...
    argList["html.enginesTitle"] = fetchIndexTitle("/engines/search", "/engines/list", "engines").output();
