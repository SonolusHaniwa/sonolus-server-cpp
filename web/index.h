...
auto web_index = [](client_conn conn, http_request request, param argv) {
    ...
    argList["html.levelsTitle"] = fetchIndexTitle("/levels/search/0", "/levels/list", "levels").output();
    ...
    argList["html.levelsBottom"] = fetchIndexBottom("/levels/search/0", "/levels/list").output();

    argList["html.skinsTitle"] = fetchIndexTitle("/skins/search/0", "/skins/list", "skins").output();
    ...
    argList["html.skinsBottom"] = fetchIndexBottom("/skins/search/0", "/skins/list").output();

    argList["html.backgroundsTitle"] = fetchIndexTitle("/backgrounds/search/0", "/backgrounds/list", "backgrounds").output();
    ...
    argList["html.backgroundsBottom"] = fetchIndexBottom("/backgrounds/search/0", "/backgrounds/list").output();
    
    argList["html.effectsTitle"] = fetchIndexTitle("/effects/search/0", "/effect/list", "effects").output();
    ...
    argList["html.effectsBottom"] = fetchIndexBottom("/effects/search/0", "/effects/list").output();

    argList["html.particlesTitle"] = fetchIndexTitle("/particles/search/0", "/particles/list", "particles").output();
    ...
    argList["html.particlesBottom"] = fetchIndexBottom("/particles/search/0", "/particles/list").output();\

    argList["html.enginesTitle"] = fetchIndexTitle("/engines/search/0", "/engines/list", "engines").output();
    ...
    argList["html.enginesBottom"] = fetchIndexBottom("/engines/search/0", "/engines/list").output();
